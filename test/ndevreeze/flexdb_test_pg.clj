...
(comment
  (have-postgres-test-db?)
  (db/open-db-spec (get-test-db-spec-pg))
  )

;; 2026-03-29: wrt clj-kondo warnings.
(declare handle)
...
;; 2026-03-29: For clj-kondo, => was not known.
(declare =>)
